...
// //   // Prevent sending undefined fields
// //   const cleanedData = {};
...
//   if (!plant) return <div className="text-center mt-10">Loading plant data...</div>;
...
// //update not worked written my same code not change correct code to perfactly 
